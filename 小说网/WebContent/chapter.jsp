...
<%
    ...
    String Ccc=request.getParameter("zzz");
    
    int a = Integer.parseInt(Ccc);
...
<div class="row">
			...
			<div class="col-md-4">
				<div class="sousuolan">
				<form action="shouye.html"method="post"name="biaodan"autocomplete="on">
		...
		<div class="read">
			...
			<div class="crumb">
					...
					>
					<%
					    String SQL2="select * from resource where  zhangjie= '"+Ccc+"' AND booknumber = '"+Bbb+"'";
			...
			<div class="title">
				   <div class="words">
					...
					<% 
				       String queryNumberSQL="select * from resource where  zhangjie= '"+Ccc+"' AND booknumber = '"+Bbb+"'";
                       rs=st.executeQuery(queryNumberSQL);
                       if(rs.next()){
                    %>
					<h2><%=rs.getString("zjname")%></h2>
					<%} %>
			</div>
			    <%
					    String SQL3="select * from book where  booknumber = '"+Bbb+"'";
				...
				<div class="bookinfo">
					...
					&nbsp&nbsp|&nbsp&nbsp字数：
					<span><%=rs.getString("bookword") %></span>
					&nbsp&nbsp|&nbsp&nbsp更新时间：
					<span><%=rs.getString("booktime") %></span>
					<%} %>
				</div>
				...
				<div class="content">
				  <pre id="content">
				   <% 
				       String SQL1="select * from resource where  zhangjie= '"+Ccc+"' AND booknumber = '"+Bbb+"'";
                       rs=st.executeQuery(SQL1);
                       if(rs.next()){
                    %>
				   <%=rs.getString("source2") %>
			       <%} %>
				  </pre>
			    </div>
			    <div class="like">
