...
<div class="container-login">
    <div class="myform">
        <h3>找回密码</h3>
        <form id="form2" action="do_findpassword.jsp"method="post"name="denglubiaodan"autocomplete="on">
            <ul>
                <p style="text-align: left;">用户名</p><li><input type="text" name="uname" id="uname"></li>
                <p style="text-align: left;">手机号</p><li><input type="text" name="uphone" id="uphone"></li>
            </ul>
            <div class="submit">
