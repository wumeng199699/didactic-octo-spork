...
<head>
    ...
    <script>
        function check() {
            ...
            var b = document.getElementById("uphone").value;
            var c = document.getElementById("upassword").value;
            var d = document.getElementById("upassword2").value;
            if (a == "" || a == null) {
                alert("请输入用户名");
                return false;
            } else if (b == "" || b == null) {
...
<div class="container-login">
    <div class="myform">
        <h3>注册</h3>
        <form id="form2" action="userRegister" method="post" name="denglubiaodan" autocomplete="on">
            <ul>
                <p style="text-align: left;">用户名</p>
                <li><input type="text" name="uname" id="uname"></li>
                <p style="text-align: left;">手机号</p>
                <li><input type="text" name="uphone" id="uphone"></li>
                <p style="text-align: left;">密码</p>
                <li><input type="password" name="upassword" id="upassword"></li>
                <p style="text-align: left;">确认密码</p>
                <li><input type="password" name="upassword2" id="upassword2"></li>
            </ul>
            <div class="submit">
                <button type="submit" onclick="check()">注册</button>
                <a href="login.jsp">
